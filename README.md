...
- **Selection Modes (Single / Multi)**: Dedicated toggle button located on the bottom control row (left side of Swap/Clone line) to switch between **Single** mode (at most 1 item checked at a time; checking a new item unchecks the previous one, and activating Single mode clears extra checkmarks if multiple were selected; disables "Check All") and **Multi** mode (multiple items checked simultaneously).
- **Quick Operations**: Dedicated equal-width buttons for "New" (creates a new empty text at the next available sequence number), "Delete" (deletes checked lines), "Copy" (copies checked lines to clipboard), "Paste" (pastes clipboard text directly as a new sequence item), "Check All" (disabled in Single mode), and "Uncheck All". Includes informative tooltips on hover for all buttons, steppers, swap, clone, and separator controls.
...
<img width="684" height="389" alt="image" src="https://github.com/user-attachments/assets/96cd1ba7-8762-4f96-8220-c1ea42a57f28" />
...
<img width="454" height="399" alt="image" src="https://github.com/user-attachments/assets/82822375-1072-4f2f-8abe-5a8240320620" />
...
<img width="556" height="570" alt="image" src="https://github.com/user-attachments/assets/2198e423-b9b7-4f56-b755-e4e04f97ba76" />
