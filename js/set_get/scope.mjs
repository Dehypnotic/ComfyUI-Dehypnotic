// ╔═══════════════════════════════════════════════════════════════╗
// ║  Set / Get Dehypnotic - cross-graph scope helpers             ║
// ╚═══════════════════════════════════════════════════════════════╝
//
// PRIVATE NAMESPACE: every helper here scans ONLY DehypnoticSetNode /
// DehypnoticGetNode. It never touches any other pack's Set/Get-style nodes, so
