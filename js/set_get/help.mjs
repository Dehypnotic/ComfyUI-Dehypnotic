// Help content for Set / Get Dehypnotic, shown by the ? button in the node
...
registerNodeHelp("DehypnoticSetNode", {
  title: "Set Dehypnotic",
  tagline: "Store any wire under a name, then read it back anywhere with Get Dehypnotic.",
  sections: [
    {
      heading: "What it does",
      body:
        "Set Dehypnotic is a wireless wire. Connect anything into it (an image, a model, a number, a prompt) and give it a name. A Get Dehypnotic node anywhere in the workflow can then read that same value by picking the name, with no cable running across the canvas.\n\nIt also has a passthrough output: wire it straight to a node sitting nearby, and use Get nodes for the ones far away - same value either way.\n\nIt lives only in the editor. At run time the value flows straight from the original source, exactly as if you had wired it directly, so it never slows anything down or changes the result.",
    },
    {
      ...
      bullets: [
        ...
        "Wire the output to a nearby node directly, or add Get Dehypnotic nodes for far-apart ones.",
    ...
    },
    {
      heading: "Colours",
      body:
        "Colour a Set however you like (right-click -> Colors). Any Get that reads it takes the same colour, so matching pairs are easy to spot, and the Gets follow along when you recolour the Set later. Turn off 'Get matches its Set's colour' in Settings (under Dehypnotic) to leave Gets on their own colour.",
    },
    {
      heading: "Right-click menu",
      defs: [
        ["Select all its Gets", "Highlights every Get node in this graph that reads this name."],
        ["Add paired Get Dehypnotic", "Drops a Get already set to this name next to the node."],
...
registerNodeHelp("DehypnoticGetNode", {
  title: "Get Dehypnotic",
  tagline: "Read a value that a Set Dehypnotic node stored under a name, with no cable.",
  sections: [
    {
      heading: "What it does",
      body:
        "Get Dehypnotic is the other half of the wireless wire. Pick the name of a Set Dehypnotic node from its dropdown and the output carries that Set's value, matching its type and colour. Wire the output wherever you need it.\n\nLike Set, it exists only in the editor. At run time the connection resolves straight to the original source, so there is no extra cost and the result is identical to a direct cable.",
    },
    {
      heading: "How to use it",
      bullets: [
    ...
    },
    {
      heading: "Colours",
      body:
        "A Get takes the colour of the Set it reads, so a matching pair is easy to spot, and each name in the dropdown is tagged with that Set's colour. Colour the Set (right-click -> Colors) and the Get follows. Turn off 'Get matches its Set's colour' in Settings (under Dehypnotic) to leave Gets alone.",
    },
    {
      heading: "Right-click menu",
      defs: [
        ["Jump to its Set Dehypnotic", "Selects and centres the Set this Get is reading, even across subgraphs."],
      ],
    },
    {
      heading: "Subgraphs (important)",
  ...
  footer: "If the dropdown is empty, add a Set Dehypnotic node first and give it a name.",
});
